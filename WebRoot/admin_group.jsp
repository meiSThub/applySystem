    ...
    <div class="container">
      <div class="tabbable tabs-left">
        <ul id="myTab" class="nav nav-tabs">
          ...
          <li><a href="#event-approve" >活动审批</a></li>
          <li class="active"><a href="#group-user">查看单位用户</a></li>
          <li><a href="#person-user" >查看个人用户</a></li>
        </ul>
        <div id="myTabContent" class="tab-content">
          <ul class="breadcrumb">
            <li><a href="#">主页</a> <span class="divider">/</span></li>
            <li class="active">大学生IT创新工作室</li>
          </ul>
          <h1>大学生IT创新工作室
            <small>
              <p class="pull-right">成功举行<strong>43</strong>次活动</p>
            </small>
          </h1>
          <br>
          <p>联系地址：教二楼501（东风校区），电教楼522（科学校区）</p>
          <p>负责人</p>
          <p>联系电话：12345678901</p>
          <p>电子邮箱：xxx@126.com</p>
          <hr>
          <div class="event_list">
            <ul id="myTab" class="nav nav-tabs">
              <li class="active"><a href="#all-event" >审核中的活动</a></li> 
              <li><a href="#enrolling-event" >正在报名的活动</a></li>
              <li ><a href="#enrolled-event" >报名结束的活动</a></li>
              <li ><a href="#not-pass-event" >未通过审核的活动</a></li> 
            </ul>
            <div id="myTabContent" class="tab-content">
              <div class="tab-pane fade" id="enrolling-event">
                <div class="row-fluid">
                  <div class="span9"></div>
                  <div class="span11">
                      <div class="p-summary">
                        <h4><a href="./admin_event_enrolling_detail.html">美国奥克兰大学物理系教授夏阳教授学术报告</a>
                          <small>
                            <button class="btn btn-primary pull-right disabled">正在报名</button>
                          </small>
                        </h4>                
                        <div class="muted">
                          <span class="datetime">7月11日下午15:00—17:00</span>
                          <span class="users">学生 教师</span>
                          <span class="post-user">主办单位：科技处</span>
                          <span class="rest-time pull-right">剩余报名时间：1天</span>
                        </div>
                      </div>
                      <hr>
                  </div>
              ...
              <div class="tab-pane fade" id="enrolled-event">
                <div class="row-fluid">
                  <div class="span9"></div>
                  <div class="span11">
                      <div class="p-summary">
                        <h4><a href="./admin_event_enrolled_detail.html">美国奥克兰大学物理系教授夏阳教授学术报告</a>
                          <small>
                            <button class="btn pull-right disabled">报名结束</button>
                          </small>
                        </h4>                
                        <div class="muted">
                          <span class="datetime">7月11日下午15:00—17:00</span>
              ...
              <div class="tab-pane fade in active" id="all-event">
                <div class="row-fluid">
                  <div class="span9"></div>
                  <div class="span11">
                      <div class="p-summary">
                        <h4><a href="./admin_event_detail.html">美国奥克兰大学物理系教授夏阳教授学术报告</a>
                          <small>
              ...
              <div class="tab-pane fade" id="not-pass-event">
                <div class="row-fluid">
                  <div class="span9"></div>
                  <div class="span11">
                      <div class="p-summary">
                        <h4><a href="./admin_event_denied_detail.html">美国奥克兰大学物理系教授夏阳教授学术报告</a>
                          <small>
                            <button class="btn btn-danger pull-right disabled">未通过审核</button>
                          </small>
                        </h4>                
                        <div class="muted">
                          <span class="datetime">7月11日下午15:00—17:00</span>
